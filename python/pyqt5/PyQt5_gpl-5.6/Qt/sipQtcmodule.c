...
#endif
{
    ...
    sip_import_component_module(sipModuleDict, "PyQt5.QtX11Extras");
    ...
    sip_import_component_module(sipModuleDict, "PyQt5.QtWebEngineCore");
    sip_import_component_module(sipModuleDict, "PyQt5.QtWebEngineWidgets");
    sip_import_component_module(sipModuleDict, "PyQt5.QtLocation");
