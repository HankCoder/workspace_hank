...
#line 29 "/home/pythoner/workspace_hank/python/pyqt5/PyQt-gpl-5.1/QtGui/sipQtGuiQOpenGLDebugMessage.cpp"

#line 27 "sip/QtCore/qstring.sip"
#include <qstring.h>
#line 33 "/home/pythoner/workspace_hank/python/pyqt5/PyQt-gpl-5.1/QtGui/sipQtGuiQOpenGLDebugMessage.cpp"
...
PyDoc_STRVAR(doc_QOpenGLDebugMessage_message, "message(self) -> object");
...
PyDoc_STRVAR(doc_QOpenGLDebugMessage_createApplicationMessage, "createApplicationMessage(object, id: int = 0, severity: QOpenGLDebugMessage.Severity = QOpenGLDebugMessage.NotificationSeverity, type: QOpenGLDebugMessage.Type = QOpenGLDebugMessage.OtherType) -> QOpenGLDebugMessage");
...
PyDoc_STRVAR(doc_QOpenGLDebugMessage_createThirdPartyMessage, "createThirdPartyMessage(object, id: int = 0, severity: QOpenGLDebugMessage.Severity = QOpenGLDebugMessage.NotificationSeverity, type: QOpenGLDebugMessage.Type = QOpenGLDebugMessage.OtherType) -> QOpenGLDebugMessage");
...
static sipEnumMemberDef enummembers_QOpenGLDebugMessage[] = {
    {sipName_APISource, static_cast<int>(QOpenGLDebugMessage::APISource), 129},
    {sipName_AnySeverity, static_cast<int>(QOpenGLDebugMessage::AnySeverity), 128},
    {sipName_AnySource, static_cast<int>(QOpenGLDebugMessage::AnySource), 129},
    {sipName_AnyType, static_cast<int>(QOpenGLDebugMessage::AnyType), 131},
    {sipName_ApplicationSource, static_cast<int>(QOpenGLDebugMessage::ApplicationSource), 129},
    {sipName_DeprecatedBehaviorType, static_cast<int>(QOpenGLDebugMessage::DeprecatedBehaviorType), 131},
    {sipName_ErrorType, static_cast<int>(QOpenGLDebugMessage::ErrorType), 131},
    {sipName_GroupPopType, static_cast<int>(QOpenGLDebugMessage::GroupPopType), 131},
    {sipName_GroupPushType, static_cast<int>(QOpenGLDebugMessage::GroupPushType), 131},
    {sipName_HighSeverity, static_cast<int>(QOpenGLDebugMessage::HighSeverity), 128},
    {sipName_InvalidSeverity, static_cast<int>(QOpenGLDebugMessage::InvalidSeverity), 128},
    {sipName_InvalidSource, static_cast<int>(QOpenGLDebugMessage::InvalidSource), 129},
    {sipName_InvalidType, static_cast<int>(QOpenGLDebugMessage::InvalidType), 131},
    {sipName_LowSeverity, static_cast<int>(QOpenGLDebugMessage::LowSeverity), 128},
    {sipName_MarkerType, static_cast<int>(QOpenGLDebugMessage::MarkerType), 131},
    {sipName_MediumSeverity, static_cast<int>(QOpenGLDebugMessage::MediumSeverity), 128},
    {sipName_NotificationSeverity, static_cast<int>(QOpenGLDebugMessage::NotificationSeverity), 128},
    {sipName_OtherSource, static_cast<int>(QOpenGLDebugMessage::OtherSource), 129},
    {sipName_OtherType, static_cast<int>(QOpenGLDebugMessage::OtherType), 131},
    {sipName_PerformanceType, static_cast<int>(QOpenGLDebugMessage::PerformanceType), 131},
    {sipName_PortabilityType, static_cast<int>(QOpenGLDebugMessage::PortabilityType), 131},
    {sipName_ShaderCompilerSource, static_cast<int>(QOpenGLDebugMessage::ShaderCompilerSource), 129},
    {sipName_ThirdPartySource, static_cast<int>(QOpenGLDebugMessage::ThirdPartySource), 129},
    {sipName_UndefinedBehaviorType, static_cast<int>(QOpenGLDebugMessage::UndefinedBehaviorType), 131},
    {sipName_WindowSystemSource, static_cast<int>(QOpenGLDebugMessage::WindowSystemSource), 129},
};
