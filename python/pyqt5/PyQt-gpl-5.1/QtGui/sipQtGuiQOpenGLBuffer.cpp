...
#line 29 "/home/pythoner/workspace_hank/python/pyqt5/PyQt-gpl-5.1/QtGui/sipQtGuiQOpenGLBuffer.cpp"
...
#line 502 "/home/pythoner/workspace_hank/python/pyqt5/PyQt-gpl-5.1/QtGui/sipQtGuiQOpenGLBuffer.cpp"
...
static sipEnumMemberDef enummembers_QOpenGLBuffer[] = {
    {sipName_DynamicCopy, static_cast<int>(QOpenGLBuffer::DynamicCopy), 121},
    {sipName_DynamicDraw, static_cast<int>(QOpenGLBuffer::DynamicDraw), 121},
    {sipName_DynamicRead, static_cast<int>(QOpenGLBuffer::DynamicRead), 121},
    {sipName_IndexBuffer, static_cast<int>(QOpenGLBuffer::IndexBuffer), 120},
    {sipName_PixelPackBuffer, static_cast<int>(QOpenGLBuffer::PixelPackBuffer), 120},
    {sipName_PixelUnpackBuffer, static_cast<int>(QOpenGLBuffer::PixelUnpackBuffer), 120},
    {sipName_ReadOnly, static_cast<int>(QOpenGLBuffer::ReadOnly), 119},
    {sipName_ReadWrite, static_cast<int>(QOpenGLBuffer::ReadWrite), 119},
    {sipName_StaticCopy, static_cast<int>(QOpenGLBuffer::StaticCopy), 121},
    {sipName_StaticDraw, static_cast<int>(QOpenGLBuffer::StaticDraw), 121},
    {sipName_StaticRead, static_cast<int>(QOpenGLBuffer::StaticRead), 121},
    {sipName_StreamCopy, static_cast<int>(QOpenGLBuffer::StreamCopy), 121},
    {sipName_StreamDraw, static_cast<int>(QOpenGLBuffer::StreamDraw), 121},
    {sipName_StreamRead, static_cast<int>(QOpenGLBuffer::StreamRead), 121},
    {sipName_VertexBuffer, static_cast<int>(QOpenGLBuffer::VertexBuffer), 120},
    {sipName_WriteOnly, static_cast<int>(QOpenGLBuffer::WriteOnly), 119},
};
