...
#line 29 "/home/pythoner/workspace_hank/python/pyqt5/PyQt-gpl-5.1/QtGui/sipQtGuiQKeySequence.cpp"

#line 27 "sip/QtCore/qstring.sip"
#include <qstring.h>
#line 33 "/home/pythoner/workspace_hank/python/pyqt5/PyQt-gpl-5.1/QtGui/sipQtGuiQKeySequence.cpp"
#line 30 "sip/QtCore/qvariant.sip"
#include <qvariant.h>
#line 36 "/home/pythoner/workspace_hank/python/pyqt5/PyQt-gpl-5.1/QtGui/sipQtGuiQKeySequence.cpp"
#line 28 "sip/QtCore/qlist.sip"
#include <qlist.h>
#line 39 "/home/pythoner/workspace_hank/python/pyqt5/PyQt-gpl-5.1/QtGui/sipQtGuiQKeySequence.cpp"
...
PyDoc_STRVAR(doc_QKeySequence_mnemonic, "mnemonic(object) -> QKeySequence");
...
PyDoc_STRVAR(doc_QKeySequence_toString, "toString(self, format: QKeySequence.SequenceFormat = QKeySequence.PortableText) -> object");
...
PyDoc_STRVAR(doc_QKeySequence_fromString, "fromString(object, format: QKeySequence.SequenceFormat = QKeySequence.PortableText) -> QKeySequence");
...
PyDoc_STRVAR(doc_QKeySequence_listFromString, "listFromString(object, format: QKeySequence.SequenceFormat = QKeySequence.PortableText) -> object");
...
PyDoc_STRVAR(doc_QKeySequence_listToString, "listToString(object, format: QKeySequence.SequenceFormat = QKeySequence.PortableText) -> object");
...
#line 202 "/home/pythoner/workspace_hank/python/pyqt5/PyQt-gpl-5.1/sip/QtGui/qkeysequence.sip"
...
#line 615 "/home/pythoner/workspace_hank/python/pyqt5/PyQt-gpl-5.1/QtGui/sipQtGuiQKeySequence.cpp"
...
#line 646 "/home/pythoner/workspace_hank/python/pyqt5/PyQt-gpl-5.1/QtGui/sipQtGuiQKeySequence.cpp"
...
#line 95 "/home/pythoner/workspace_hank/python/pyqt5/PyQt-gpl-5.1/sip/QtGui/qkeysequence.sip"
    sipRes = Py_BuildValue((char *)"iiii", sipCpp->operator[](0), sipCpp->operator[](1), sipCpp->operator[](2), sipCpp->operator[](3));
#line 672 "/home/pythoner/workspace_hank/python/pyqt5/PyQt-gpl-5.1/QtGui/sipQtGuiQKeySequence.cpp"
...
static void *init_type_QKeySequence(sipSimpleWrapper *, PyObject *sipArgs, PyObject *sipKwds, PyObject **sipUnused, PyObject **, PyObject **sipParseErr)
{
...

    {
        ...
        {
#line 192 "/home/pythoner/workspace_hank/python/pyqt5/PyQt-gpl-5.1/sip/QtGui/qkeysequence.sip"
        sipCpp = new QKeySequence(a0->value<QKeySequence>());
#line 784 "/home/pythoner/workspace_hank/python/pyqt5/PyQt-gpl-5.1/QtGui/sipQtGuiQKeySequence.cpp"
...
#line 34 "/home/pythoner/workspace_hank/python/pyqt5/PyQt-gpl-5.1/sip/QtGui/qkeysequence.sip"
...
return sipGetState(sipTransferObj);
#line 859 "/home/pythoner/workspace_hank/python/pyqt5/PyQt-gpl-5.1/QtGui/sipQtGuiQKeySequence.cpp"
}
...
static sipEnumMemberDef enummembers_QKeySequence[] = {
    {sipName_AddTab, static_cast<int>(QKeySequence::AddTab), 83},
    {sipName_Back, static_cast<int>(QKeySequence::Back), 83},
    {sipName_Bold, static_cast<int>(QKeySequence::Bold), 83},
    {sipName_Close, static_cast<int>(QKeySequence::Close), 83},
    {sipName_Copy, static_cast<int>(QKeySequence::Copy), 83},
    {sipName_Cut, static_cast<int>(QKeySequence::Cut), 83},
    {sipName_Delete, static_cast<int>(QKeySequence::Delete), 83},
    {sipName_DeleteEndOfLine, static_cast<int>(QKeySequence::DeleteEndOfLine), 83},
    {sipName_DeleteEndOfWord, static_cast<int>(QKeySequence::DeleteEndOfWord), 83},
    {sipName_DeleteStartOfWord, static_cast<int>(QKeySequence::DeleteStartOfWord), 83},
    {sipName_Deselect, static_cast<int>(QKeySequence::Deselect), 83},
    {sipName_ExactMatch, static_cast<int>(QKeySequence::ExactMatch), 82},
    {sipName_Find, static_cast<int>(QKeySequence::Find), 83},
    {sipName_FindNext, static_cast<int>(QKeySequence::FindNext), 83},
    {sipName_FindPrevious, static_cast<int>(QKeySequence::FindPrevious), 83},
    {sipName_Forward, static_cast<int>(QKeySequence::Forward), 83},
    {sipName_FullScreen, static_cast<int>(QKeySequence::FullScreen), 83},
    {sipName_HelpContents, static_cast<int>(QKeySequence::HelpContents), 83},
    {sipName_InsertLineSeparator, static_cast<int>(QKeySequence::InsertLineSeparator), 83},
    {sipName_InsertParagraphSeparator, static_cast<int>(QKeySequence::InsertParagraphSeparator), 83},
    {sipName_Italic, static_cast<int>(QKeySequence::Italic), 83},
    {sipName_MoveToEndOfBlock, static_cast<int>(QKeySequence::MoveToEndOfBlock), 83},
    {sipName_MoveToEndOfDocument, static_cast<int>(QKeySequence::MoveToEndOfDocument), 83},
    {sipName_MoveToEndOfLine, static_cast<int>(QKeySequence::MoveToEndOfLine), 83},
    {sipName_MoveToNextChar, static_cast<int>(QKeySequence::MoveToNextChar), 83},
    {sipName_MoveToNextLine, static_cast<int>(QKeySequence::MoveToNextLine), 83},
    {sipName_MoveToNextPage, static_cast<int>(QKeySequence::MoveToNextPage), 83},
    {sipName_MoveToNextWord, static_cast<int>(QKeySequence::MoveToNextWord), 83},
    {sipName_MoveToPreviousChar, static_cast<int>(QKeySequence::MoveToPreviousChar), 83},
    {sipName_MoveToPreviousLine, static_cast<int>(QKeySequence::MoveToPreviousLine), 83},
    {sipName_MoveToPreviousPage, static_cast<int>(QKeySequence::MoveToPreviousPage), 83},
    {sipName_MoveToPreviousWord, static_cast<int>(QKeySequence::MoveToPreviousWord), 83},
    {sipName_MoveToStartOfBlock, static_cast<int>(QKeySequence::MoveToStartOfBlock), 83},
    {sipName_MoveToStartOfDocument, static_cast<int>(QKeySequence::MoveToStartOfDocument), 83},
    {sipName_MoveToStartOfLine, static_cast<int>(QKeySequence::MoveToStartOfLine), 83},
    {sipName_NativeText, static_cast<int>(QKeySequence::NativeText), 81},
    {sipName_New, static_cast<int>(QKeySequence::New), 83},
    {sipName_NextChild, static_cast<int>(QKeySequence::NextChild), 83},
    {sipName_NoMatch, static_cast<int>(QKeySequence::NoMatch), 82},
    {sipName_Open, static_cast<int>(QKeySequence::Open), 83},
    {sipName_PartialMatch, static_cast<int>(QKeySequence::PartialMatch), 82},
    {sipName_Paste, static_cast<int>(QKeySequence::Paste), 83},
    {sipName_PortableText, static_cast<int>(QKeySequence::PortableText), 81},
    {sipName_Preferences, static_cast<int>(QKeySequence::Preferences), 83},
    {sipName_PreviousChild, static_cast<int>(QKeySequence::PreviousChild), 83},
    {sipName_Print, static_cast<int>(QKeySequence::Print), 83},
    {sipName_Quit, static_cast<int>(QKeySequence::Quit), 83},
    {sipName_Redo, static_cast<int>(QKeySequence::Redo), 83},
    {sipName_Refresh, static_cast<int>(QKeySequence::Refresh), 83},
    {sipName_Replace, static_cast<int>(QKeySequence::Replace), 83},
    {sipName_Save, static_cast<int>(QKeySequence::Save), 83},
    {sipName_SaveAs, static_cast<int>(QKeySequence::SaveAs), 83},
    {sipName_SelectAll, static_cast<int>(QKeySequence::SelectAll), 83},
    {sipName_SelectEndOfBlock, static_cast<int>(QKeySequence::SelectEndOfBlock), 83},
    {sipName_SelectEndOfDocument, static_cast<int>(QKeySequence::SelectEndOfDocument), 83},
    {sipName_SelectEndOfLine, static_cast<int>(QKeySequence::SelectEndOfLine), 83},
    {sipName_SelectNextChar, static_cast<int>(QKeySequence::SelectNextChar), 83},
    {sipName_SelectNextLine, static_cast<int>(QKeySequence::SelectNextLine), 83},
    {sipName_SelectNextPage, static_cast<int>(QKeySequence::SelectNextPage), 83},
    {sipName_SelectNextWord, static_cast<int>(QKeySequence::SelectNextWord), 83},
    {sipName_SelectPreviousChar, static_cast<int>(QKeySequence::SelectPreviousChar), 83},
    {sipName_SelectPreviousLine, static_cast<int>(QKeySequence::SelectPreviousLine), 83},
    {sipName_SelectPreviousPage, static_cast<int>(QKeySequence::SelectPreviousPage), 83},
    {sipName_SelectPreviousWord, static_cast<int>(QKeySequence::SelectPreviousWord), 83},
    {sipName_SelectStartOfBlock, static_cast<int>(QKeySequence::SelectStartOfBlock), 83},
    {sipName_SelectStartOfDocument, static_cast<int>(QKeySequence::SelectStartOfDocument), 83},
    {sipName_SelectStartOfLine, static_cast<int>(QKeySequence::SelectStartOfLine), 83},
    {sipName_Underline, static_cast<int>(QKeySequence::Underline), 83},
    {sipName_Undo, static_cast<int>(QKeySequence::Undo), 83},
    {sipName_UnknownKey, static_cast<int>(QKeySequence::UnknownKey), 83},
    {sipName_WhatsThis, static_cast<int>(QKeySequence::WhatsThis), 83},
    {sipName_ZoomIn, static_cast<int>(QKeySequence::ZoomIn), 83},
    {sipName_ZoomOut, static_cast<int>(QKeySequence::ZoomOut), 83},
};

PyDoc_STRVAR(doc_QKeySequence, "\1QKeySequence()\n"
    "QKeySequence(QKeySequence)\n"
    "QKeySequence(object, format: QKeySequence.SequenceFormat = QKeySequence.NativeText)\n"
