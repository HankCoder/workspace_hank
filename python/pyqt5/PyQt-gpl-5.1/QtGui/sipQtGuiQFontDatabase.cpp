...
#line 29 "/home/pythoner/workspace_hank/python/pyqt5/PyQt-gpl-5.1/QtGui/sipQtGuiQFontDatabase.cpp"

#line 27 "sip/QtCore/qstringlist.sip"
#include <qstringlist.h>
#line 33 "/home/pythoner/workspace_hank/python/pyqt5/PyQt-gpl-5.1/QtGui/sipQtGuiQFontDatabase.cpp"
#line 32 "sip/QtCore/qbytearray.sip"
#include <qbytearray.h>
#line 36 "/home/pythoner/workspace_hank/python/pyqt5/PyQt-gpl-5.1/QtGui/sipQtGuiQFontDatabase.cpp"
#line 27 "sip/QtCore/qstring.sip"
#include <qstring.h>
#line 39 "/home/pythoner/workspace_hank/python/pyqt5/PyQt-gpl-5.1/QtGui/sipQtGuiQFontDatabase.cpp"
#line 30 "/home/pythoner/workspace_hank/python/pyqt5/PyQt-gpl-5.1/sip/QtGui/qfont.sip"
#include <qfont.h>
#line 42 "/home/pythoner/workspace_hank/python/pyqt5/PyQt-gpl-5.1/QtGui/sipQtGuiQFontDatabase.cpp"
#line 26 "/home/pythoner/workspace_hank/python/pyqt5/PyQt-gpl-5.1/sip/QtGui/qfontinfo.sip"
#include <qfontinfo.h>
#line 45 "/home/pythoner/workspace_hank/python/pyqt5/PyQt-gpl-5.1/QtGui/sipQtGuiQFontDatabase.cpp"
#line 314 "sip/QtCore/qlist.sip"
#include <qlist.h>
#line 48 "/home/pythoner/workspace_hank/python/pyqt5/PyQt-gpl-5.1/QtGui/sipQtGuiQFontDatabase.cpp"
#line 101 "/home/pythoner/workspace_hank/python/pyqt5/PyQt-gpl-5.1/sip/QtGui/qfontdatabase.sip"
#include <qfontdatabase.h>
#include <qlist.h>
#line 52 "/home/pythoner/workspace_hank/python/pyqt5/PyQt-gpl-5.1/QtGui/sipQtGuiQFontDatabase.cpp"
...
PyDoc_STRVAR(doc_QFontDatabase_writingSystems, "writingSystems(self) -> object\n"
    "writingSystems(self, object) -> object");
...
PyDoc_STRVAR(doc_QFontDatabase_families, "families(self, writingSystem: QFontDatabase.WritingSystem = QFontDatabase.Any) -> object");
...
PyDoc_STRVAR(doc_QFontDatabase_styles, "styles(self, object) -> object");
...
PyDoc_STRVAR(doc_QFontDatabase_pointSizes, "pointSizes(self, object, style: object = '') -> object");
...
PyDoc_STRVAR(doc_QFontDatabase_smoothSizes, "smoothSizes(self, object, object) -> object");
...
PyDoc_STRVAR(doc_QFontDatabase_styleString, "styleString(self, QFont) -> object\n"
    "styleString(self, QFontInfo) -> object");
...
PyDoc_STRVAR(doc_QFontDatabase_font, "font(self, object, object, int) -> QFont");
...
PyDoc_STRVAR(doc_QFontDatabase_isBitmapScalable, "isBitmapScalable(self, object, style: object = '') -> bool");
...
PyDoc_STRVAR(doc_QFontDatabase_isSmoothlyScalable, "isSmoothlyScalable(self, object, style: object = '') -> bool");
...
PyDoc_STRVAR(doc_QFontDatabase_isScalable, "isScalable(self, object, style: object = '') -> bool");
...
PyDoc_STRVAR(doc_QFontDatabase_isFixedPitch, "isFixedPitch(self, object, style: object = '') -> bool");
...
PyDoc_STRVAR(doc_QFontDatabase_italic, "italic(self, object, object) -> bool");
...
PyDoc_STRVAR(doc_QFontDatabase_bold, "bold(self, object, object) -> bool");
...
PyDoc_STRVAR(doc_QFontDatabase_weight, "weight(self, object, object) -> int");
...
PyDoc_STRVAR(doc_QFontDatabase_writingSystemName, "writingSystemName(QFontDatabase.WritingSystem) -> object");
...
PyDoc_STRVAR(doc_QFontDatabase_writingSystemSample, "writingSystemSample(QFontDatabase.WritingSystem) -> object");
...
PyDoc_STRVAR(doc_QFontDatabase_addApplicationFont, "addApplicationFont(object) -> int");
...
PyDoc_STRVAR(doc_QFontDatabase_applicationFontFamilies, "applicationFontFamilies(int) -> object");
...
static sipEnumMemberDef enummembers_QFontDatabase[] = {
    {sipName_Any, static_cast<int>(QFontDatabase::Any), 40},
    {sipName_Arabic, static_cast<int>(QFontDatabase::Arabic), 40},
    {sipName_Armenian, static_cast<int>(QFontDatabase::Armenian), 40},
    {sipName_Bengali, static_cast<int>(QFontDatabase::Bengali), 40},
    {sipName_Cyrillic, static_cast<int>(QFontDatabase::Cyrillic), 40},
    {sipName_Devanagari, static_cast<int>(QFontDatabase::Devanagari), 40},
    {sipName_Georgian, static_cast<int>(QFontDatabase::Georgian), 40},
    {sipName_Greek, static_cast<int>(QFontDatabase::Greek), 40},
    {sipName_Gujarati, static_cast<int>(QFontDatabase::Gujarati), 40},
    {sipName_Gurmukhi, static_cast<int>(QFontDatabase::Gurmukhi), 40},
    {sipName_Hebrew, static_cast<int>(QFontDatabase::Hebrew), 40},
    {sipName_Japanese, static_cast<int>(QFontDatabase::Japanese), 40},
    {sipName_Kannada, static_cast<int>(QFontDatabase::Kannada), 40},
    {sipName_Khmer, static_cast<int>(QFontDatabase::Khmer), 40},
    {sipName_Korean, static_cast<int>(QFontDatabase::Korean), 40},
    {sipName_Lao, static_cast<int>(QFontDatabase::Lao), 40},
    {sipName_Latin, static_cast<int>(QFontDatabase::Latin), 40},
    {sipName_Malayalam, static_cast<int>(QFontDatabase::Malayalam), 40},
    {sipName_Myanmar, static_cast<int>(QFontDatabase::Myanmar), 40},
    {sipName_Nko, static_cast<int>(QFontDatabase::Nko), 40},
    {sipName_Ogham, static_cast<int>(QFontDatabase::Ogham), 40},
    {sipName_Oriya, static_cast<int>(QFontDatabase::Oriya), 40},
    {sipName_Other, static_cast<int>(QFontDatabase::Other), 40},
    {sipName_Runic, static_cast<int>(QFontDatabase::Runic), 40},
    {sipName_SimplifiedChinese, static_cast<int>(QFontDatabase::SimplifiedChinese), 40},
    {sipName_Sinhala, static_cast<int>(QFontDatabase::Sinhala), 40},
    {sipName_Symbol, static_cast<int>(QFontDatabase::Symbol), 40},
    {sipName_Syriac, static_cast<int>(QFontDatabase::Syriac), 40},
    {sipName_Tamil, static_cast<int>(QFontDatabase::Tamil), 40},
    {sipName_Telugu, static_cast<int>(QFontDatabase::Telugu), 40},
    {sipName_Thaana, static_cast<int>(QFontDatabase::Thaana), 40},
    {sipName_Thai, static_cast<int>(QFontDatabase::Thai), 40},
    {sipName_Tibetan, static_cast<int>(QFontDatabase::Tibetan), 40},
    {sipName_TraditionalChinese, static_cast<int>(QFontDatabase::TraditionalChinese), 40},
    {sipName_Vietnamese, static_cast<int>(QFontDatabase::Vietnamese), 40},
};
