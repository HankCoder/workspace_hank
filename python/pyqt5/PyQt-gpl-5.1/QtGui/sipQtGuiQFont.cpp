...
#include <qfont.h>
#line 29 "/home/pythoner/workspace_hank/python/pyqt5/PyQt-gpl-5.1/QtGui/sipQtGuiQFont.cpp"

#line 27 "sip/QtCore/qstring.sip"
#include <qstring.h>
#line 33 "/home/pythoner/workspace_hank/python/pyqt5/PyQt-gpl-5.1/QtGui/sipQtGuiQFont.cpp"
#line 26 "/home/pythoner/workspace_hank/python/pyqt5/PyQt-gpl-5.1/sip/QtGui/qpaintdevice.sip"
#include <qpaintdevice.h>
#line 36 "/home/pythoner/workspace_hank/python/pyqt5/PyQt-gpl-5.1/QtGui/sipQtGuiQFont.cpp"
#line 30 "sip/QtCore/qvariant.sip"
#include <qvariant.h>
#line 39 "/home/pythoner/workspace_hank/python/pyqt5/PyQt-gpl-5.1/QtGui/sipQtGuiQFont.cpp"
#line 27 "sip/QtCore/qstringlist.sip"
#include <qstringlist.h>
#line 42 "/home/pythoner/workspace_hank/python/pyqt5/PyQt-gpl-5.1/QtGui/sipQtGuiQFont.cpp"


PyDoc_STRVAR(doc_QFont_family, "family(self) -> object");
...
PyDoc_STRVAR(doc_QFont_setFamily, "setFamily(self, object)");
...
PyDoc_STRVAR(doc_QFont_setRawName, "setRawName(self, object)");
...
PyDoc_STRVAR(doc_QFont_rawName, "rawName(self) -> object");
...
PyDoc_STRVAR(doc_QFont_key, "key(self) -> object");
...
PyDoc_STRVAR(doc_QFont_toString, "toString(self) -> object");
...
PyDoc_STRVAR(doc_QFont_fromString, "fromString(self, object) -> bool");
...
PyDoc_STRVAR(doc_QFont_substitute, "substitute(object) -> object");
...
PyDoc_STRVAR(doc_QFont_substitutes, "substitutes(object) -> object");
...
PyDoc_STRVAR(doc_QFont_substitutions, "substitutions() -> object");
...
PyDoc_STRVAR(doc_QFont_insertSubstitution, "insertSubstitution(object, object)");
...
PyDoc_STRVAR(doc_QFont_insertSubstitutions, "insertSubstitutions(object, object)");
...
PyDoc_STRVAR(doc_QFont_removeSubstitutions, "removeSubstitutions(object)");
...
PyDoc_STRVAR(doc_QFont_defaultFamily, "defaultFamily(self) -> object");
...
PyDoc_STRVAR(doc_QFont_lastResortFamily, "lastResortFamily(self) -> object");
...
PyDoc_STRVAR(doc_QFont_lastResortFont, "lastResortFont(self) -> object");
...
PyDoc_STRVAR(doc_QFont_styleName, "styleName(self) -> object");
...
PyDoc_STRVAR(doc_QFont_setStyleName, "setStyleName(self, object)");
...
static void *init_type_QFont(sipSimpleWrapper *, PyObject *sipArgs, PyObject *sipKwds, PyObject **sipUnused, PyObject **, PyObject **sipParseErr)
{
...

    {
        ...
        {
#line 102 "/home/pythoner/workspace_hank/python/pyqt5/PyQt-gpl-5.1/sip/QtGui/qfont.sip"
        sipCpp = new QFont(a0->value<QFont>());
#line 2148 "/home/pythoner/workspace_hank/python/pyqt5/PyQt-gpl-5.1/QtGui/sipQtGuiQFont.cpp"
...
static sipEnumMemberDef enummembers_QFont[] = {
    {sipName_AbsoluteSpacing, static_cast<int>(QFont::AbsoluteSpacing), 33},
    {sipName_AllLowercase, static_cast<int>(QFont::AllLowercase), 31},
    {sipName_AllUppercase, static_cast<int>(QFont::AllUppercase), 31},
    {sipName_AnyStyle, static_cast<int>(QFont::AnyStyle), 36},
    {sipName_Black, static_cast<int>(QFont::Black), 38},
    {sipName_Bold, static_cast<int>(QFont::Bold), 38},
    {sipName_Capitalize, static_cast<int>(QFont::Capitalize), 31},
    {sipName_Condensed, static_cast<int>(QFont::Condensed), 34},
    {sipName_Courier, static_cast<int>(QFont::Courier), 36},
    {sipName_Cursive, static_cast<int>(QFont::Cursive), 36},
    {sipName_Decorative, static_cast<int>(QFont::Decorative), 36},
    {sipName_DemiBold, static_cast<int>(QFont::DemiBold), 38},
    {sipName_Expanded, static_cast<int>(QFont::Expanded), 34},
    {sipName_ExtraCondensed, static_cast<int>(QFont::ExtraCondensed), 34},
    {sipName_ExtraExpanded, static_cast<int>(QFont::ExtraExpanded), 34},
    {sipName_Fantasy, static_cast<int>(QFont::Fantasy), 36},
    {sipName_ForceIntegerMetrics, static_cast<int>(QFont::ForceIntegerMetrics), 37},
    {sipName_ForceOutline, static_cast<int>(QFont::ForceOutline), 37},
    {sipName_Helvetica, static_cast<int>(QFont::Helvetica), 36},
    {sipName_Light, static_cast<int>(QFont::Light), 38},
    {sipName_MixedCase, static_cast<int>(QFont::MixedCase), 31},
    {sipName_Monospace, static_cast<int>(QFont::Monospace), 36},
    {sipName_NoAntialias, static_cast<int>(QFont::NoAntialias), 37},
    {sipName_NoFontMerging, static_cast<int>(QFont::NoFontMerging), 37},
    {sipName_Normal, static_cast<int>(QFont::Normal), 38},
    {sipName_OldEnglish, static_cast<int>(QFont::OldEnglish), 36},
    {sipName_OpenGLCompatible, static_cast<int>(QFont::OpenGLCompatible), 37},
    {sipName_PercentageSpacing, static_cast<int>(QFont::PercentageSpacing), 33},
    {sipName_PreferAntialias, static_cast<int>(QFont::PreferAntialias), 37},
    {sipName_PreferBitmap, static_cast<int>(QFont::PreferBitmap), 37},
    {sipName_PreferDefault, static_cast<int>(QFont::PreferDefault), 37},
    {sipName_PreferDefaultHinting, static_cast<int>(QFont::PreferDefaultHinting), 32},
    {sipName_PreferDevice, static_cast<int>(QFont::PreferDevice), 37},
    {sipName_PreferFullHinting, static_cast<int>(QFont::PreferFullHinting), 32},
    {sipName_PreferMatch, static_cast<int>(QFont::PreferMatch), 37},
    {sipName_PreferNoHinting, static_cast<int>(QFont::PreferNoHinting), 32},
    {sipName_PreferOutline, static_cast<int>(QFont::PreferOutline), 37},
    {sipName_PreferQuality, static_cast<int>(QFont::PreferQuality), 37},
    {sipName_PreferVerticalHinting, static_cast<int>(QFont::PreferVerticalHinting), 32},
    {sipName_SansSerif, static_cast<int>(QFont::SansSerif), 36},
    {sipName_SemiCondensed, static_cast<int>(QFont::SemiCondensed), 34},
    {sipName_SemiExpanded, static_cast<int>(QFont::SemiExpanded), 34},
    {sipName_Serif, static_cast<int>(QFont::Serif), 36},
    {sipName_SmallCaps, static_cast<int>(QFont::SmallCaps), 31},
    {sipName_StyleItalic, static_cast<int>(QFont::StyleItalic), 35},
    {sipName_StyleNormal, static_cast<int>(QFont::StyleNormal), 35},
    {sipName_StyleOblique, static_cast<int>(QFont::StyleOblique), 35},
    {sipName_System, static_cast<int>(QFont::System), 36},
    {sipName_Times, static_cast<int>(QFont::Times), 36},
    {sipName_TypeWriter, static_cast<int>(QFont::TypeWriter), 36},
    {sipName_UltraCondensed, static_cast<int>(QFont::UltraCondensed), 34},
    {sipName_UltraExpanded, static_cast<int>(QFont::UltraExpanded), 34},
    {sipName_Unstretched, static_cast<int>(QFont::Unstretched), 34},
};

PyDoc_STRVAR(doc_QFont, "\1QFont()\n"
    "QFont(object, pointSize: int = -1, weight: int = -1, italic: bool = False)\n"
