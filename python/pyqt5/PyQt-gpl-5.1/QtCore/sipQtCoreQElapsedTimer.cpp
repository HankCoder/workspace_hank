...
#line 29 "/home/pythoner/workspace_hank/python/pyqt5/PyQt-gpl-5.1/QtCore/sipQtCoreQElapsedTimer.cpp"
...
static sipEnumMemberDef enummembers_QElapsedTimer[] = {
    {sipName_MachAbsoluteTime, static_cast<int>(QElapsedTimer::MachAbsoluteTime), 45},
    {sipName_MonotonicClock, static_cast<int>(QElapsedTimer::MonotonicClock), 45},
    {sipName_PerformanceCounter, static_cast<int>(QElapsedTimer::PerformanceCounter), 45},
    {sipName_SystemTime, static_cast<int>(QElapsedTimer::SystemTime), 45},
    {sipName_TickCounter, static_cast<int>(QElapsedTimer::TickCounter), 45},
};
