...
#line 26 "/home/pythoner/workspace_hank/python/pyqt5/PyQt-gpl-5.1/sip/QtCore/qlibraryinfo.sip"
#include <qlibraryinfo.h>
#line 29 "/home/pythoner/workspace_hank/python/pyqt5/PyQt-gpl-5.1/QtCore/sipQtCoreQLibraryInfo.cpp"

#line 30 "/home/pythoner/workspace_hank/python/pyqt5/PyQt-gpl-5.1/sip/QtCore/qdatetime.sip"
#include <qdatetime.h>
#line 33 "/home/pythoner/workspace_hank/python/pyqt5/PyQt-gpl-5.1/QtCore/sipQtCoreQLibraryInfo.cpp"
#line 27 "/home/pythoner/workspace_hank/python/pyqt5/PyQt-gpl-5.1/sip/QtCore/qstring.sip"
#include <qstring.h>
#line 36 "/home/pythoner/workspace_hank/python/pyqt5/PyQt-gpl-5.1/QtCore/sipQtCoreQLibraryInfo.cpp"


PyDoc_STRVAR(doc_QLibraryInfo_licensee, "licensee() -> object");
...
PyDoc_STRVAR(doc_QLibraryInfo_licensedProducts, "licensedProducts() -> object");
...
PyDoc_STRVAR(doc_QLibraryInfo_location, "location(QLibraryInfo.LibraryLocation) -> object");
...
static sipEnumMemberDef enummembers_QLibraryInfo[] = {
    {sipName_ArchDataPath, static_cast<int>(QLibraryInfo::ArchDataPath), 83},
    {sipName_BinariesPath, static_cast<int>(QLibraryInfo::BinariesPath), 83},
    {sipName_DataPath, static_cast<int>(QLibraryInfo::DataPath), 83},
    {sipName_DocumentationPath, static_cast<int>(QLibraryInfo::DocumentationPath), 83},
    {sipName_ExamplesPath, static_cast<int>(QLibraryInfo::ExamplesPath), 83},
    {sipName_HeadersPath, static_cast<int>(QLibraryInfo::HeadersPath), 83},
    {sipName_ImportsPath, static_cast<int>(QLibraryInfo::ImportsPath), 83},
    {sipName_LibrariesPath, static_cast<int>(QLibraryInfo::LibrariesPath), 83},
    {sipName_LibraryExecutablesPath, static_cast<int>(QLibraryInfo::LibraryExecutablesPath), 83},
    {sipName_PluginsPath, static_cast<int>(QLibraryInfo::PluginsPath), 83},
    {sipName_PrefixPath, static_cast<int>(QLibraryInfo::PrefixPath), 83},
    {sipName_Qml2ImportsPath, static_cast<int>(QLibraryInfo::Qml2ImportsPath), 83},
    {sipName_SettingsPath, static_cast<int>(QLibraryInfo::SettingsPath), 83},
    {sipName_TestsPath, static_cast<int>(QLibraryInfo::TestsPath), 83},
    {sipName_TranslationsPath, static_cast<int>(QLibraryInfo::TranslationsPath), 83},
};
