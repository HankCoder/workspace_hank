...
#line 26 "/home/pythoner/workspace_hank/python/pyqt5/PyQt-gpl-5.1/sip/QtCore/qsystemsemaphore.sip"
#include <qsystemsemaphore.h>
#line 29 "/home/pythoner/workspace_hank/python/pyqt5/PyQt-gpl-5.1/QtCore/sipQtCoreQSystemSemaphore.cpp"

#line 27 "/home/pythoner/workspace_hank/python/pyqt5/PyQt-gpl-5.1/sip/QtCore/qstring.sip"
#include <qstring.h>
#line 33 "/home/pythoner/workspace_hank/python/pyqt5/PyQt-gpl-5.1/QtCore/sipQtCoreQSystemSemaphore.cpp"


PyDoc_STRVAR(doc_QSystemSemaphore_setKey, "setKey(self, object, initialValue: int = 0, mode: QSystemSemaphore.AccessMode = QSystemSemaphore.Open)");
...
PyDoc_STRVAR(doc_QSystemSemaphore_key, "key(self) -> object");
...
PyDoc_STRVAR(doc_QSystemSemaphore_errorString, "errorString(self) -> object");
...
static sipEnumMemberDef enummembers_QSystemSemaphore[] = {
    {sipName_AlreadyExists, static_cast<int>(QSystemSemaphore::AlreadyExists), 217},
    {sipName_Create, static_cast<int>(QSystemSemaphore::Create), 216},
    {sipName_KeyError, static_cast<int>(QSystemSemaphore::KeyError), 217},
    {sipName_NoError, static_cast<int>(QSystemSemaphore::NoError), 217},
    {sipName_NotFound, static_cast<int>(QSystemSemaphore::NotFound), 217},
    {sipName_Open, static_cast<int>(QSystemSemaphore::Open), 216},
    {sipName_OutOfResources, static_cast<int>(QSystemSemaphore::OutOfResources), 217},
    {sipName_PermissionDenied, static_cast<int>(QSystemSemaphore::PermissionDenied), 217},
    {sipName_UnknownError, static_cast<int>(QSystemSemaphore::UnknownError), 217},
};

PyDoc_STRVAR(doc_QSystemSemaphore, "\1QSystemSemaphore(object, initialValue: int = 0, mode: QSystemSemaphore.AccessMode = QSystemSemaphore.Open)");
