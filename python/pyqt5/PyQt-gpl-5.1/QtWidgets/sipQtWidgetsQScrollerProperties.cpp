...
#line 29 "/home/pythoner/workspace_hank/python/pyqt5/PyQt-gpl-5.1/QtWidgets/sipQtWidgetsQScrollerProperties.cpp"

#line 30 "sip/QtCore/qvariant.sip"
#include <qvariant.h>
#line 33 "/home/pythoner/workspace_hank/python/pyqt5/PyQt-gpl-5.1/QtWidgets/sipQtWidgetsQScrollerProperties.cpp"
...
PyDoc_STRVAR(doc_QScrollerProperties_scrollMetric, "scrollMetric(self, QScrollerProperties.ScrollMetric) -> QVariant");
...
PyDoc_STRVAR(doc_QScrollerProperties_setScrollMetric, "setScrollMetric(self, QScrollerProperties.ScrollMetric, QVariant)");
...
static sipEnumMemberDef enummembers_QScrollerProperties[] = {
    {sipName_AcceleratingFlickMaximumTime, static_cast<int>(QScrollerProperties::AcceleratingFlickMaximumTime), 258},
    {sipName_AcceleratingFlickSpeedupFactor, static_cast<int>(QScrollerProperties::AcceleratingFlickSpeedupFactor), 258},
    {sipName_AxisLockThreshold, static_cast<int>(QScrollerProperties::AxisLockThreshold), 258},
    {sipName_DecelerationFactor, static_cast<int>(QScrollerProperties::DecelerationFactor), 258},
    {sipName_DragStartDistance, static_cast<int>(QScrollerProperties::DragStartDistance), 258},
    {sipName_DragVelocitySmoothingFactor, static_cast<int>(QScrollerProperties::DragVelocitySmoothingFactor), 258},
    {sipName_Fps20, static_cast<int>(QScrollerProperties::Fps20), 256},
    {sipName_Fps30, static_cast<int>(QScrollerProperties::Fps30), 256},
    {sipName_Fps60, static_cast<int>(QScrollerProperties::Fps60), 256},
    {sipName_FrameRate, static_cast<int>(QScrollerProperties::FrameRate), 258},
    {sipName_HorizontalOvershootPolicy, static_cast<int>(QScrollerProperties::HorizontalOvershootPolicy), 258},
    {sipName_MaximumClickThroughVelocity, static_cast<int>(QScrollerProperties::MaximumClickThroughVelocity), 258},
    {sipName_MaximumVelocity, static_cast<int>(QScrollerProperties::MaximumVelocity), 258},
    {sipName_MinimumVelocity, static_cast<int>(QScrollerProperties::MinimumVelocity), 258},
    {sipName_MousePressEventDelay, static_cast<int>(QScrollerProperties::MousePressEventDelay), 258},
    {sipName_OvershootAlwaysOff, static_cast<int>(QScrollerProperties::OvershootAlwaysOff), 257},
    {sipName_OvershootAlwaysOn, static_cast<int>(QScrollerProperties::OvershootAlwaysOn), 257},
    {sipName_OvershootDragDistanceFactor, static_cast<int>(QScrollerProperties::OvershootDragDistanceFactor), 258},
    {sipName_OvershootDragResistanceFactor, static_cast<int>(QScrollerProperties::OvershootDragResistanceFactor), 258},
    {sipName_OvershootScrollDistanceFactor, static_cast<int>(QScrollerProperties::OvershootScrollDistanceFactor), 258},
    {sipName_OvershootScrollTime, static_cast<int>(QScrollerProperties::OvershootScrollTime), 258},
    {sipName_OvershootWhenScrollable, static_cast<int>(QScrollerProperties::OvershootWhenScrollable), 257},
    {sipName_ScrollMetricCount, static_cast<int>(QScrollerProperties::ScrollMetricCount), 258},
    {sipName_ScrollingCurve, static_cast<int>(QScrollerProperties::ScrollingCurve), 258},
    {sipName_SnapPositionRatio, static_cast<int>(QScrollerProperties::SnapPositionRatio), 258},
    {sipName_SnapTime, static_cast<int>(QScrollerProperties::SnapTime), 258},
    {sipName_Standard, static_cast<int>(QScrollerProperties::Standard), 256},
    {sipName_VerticalOvershootPolicy, static_cast<int>(QScrollerProperties::VerticalOvershootPolicy), 258},
};
