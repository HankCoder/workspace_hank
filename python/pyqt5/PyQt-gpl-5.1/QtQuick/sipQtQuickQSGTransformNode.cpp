...
#include <qsgnode.h>
#line 29 "/home/pythoner/workspace_hank/python/pyqt5/PyQt-gpl-5.1/QtQuick/sipQtQuickQSGTransformNode.cpp"

#line 30 "sip/QtGui/qmatrix4x4.sip"
#include <qmatrix4x4.h>
#line 33 "/home/pythoner/workspace_hank/python/pyqt5/PyQt-gpl-5.1/QtQuick/sipQtQuickQSGTransformNode.cpp"
#line 30 "/home/pythoner/workspace_hank/python/pyqt5/PyQt-gpl-5.1/sip/QtQuick/qsgnode.sip"
#include <qsgnode.h>
#line 36 "/home/pythoner/workspace_hank/python/pyqt5/PyQt-gpl-5.1/QtQuick/sipQtQuickQSGTransformNode.cpp"
#line 30 "/home/pythoner/workspace_hank/python/pyqt5/PyQt-gpl-5.1/sip/QtQuick/qsgnode.sip"
#include <qsgnode.h>
#line 39 "/home/pythoner/workspace_hank/python/pyqt5/PyQt-gpl-5.1/QtQuick/sipQtQuickQSGTransformNode.cpp"
#line 30 "/home/pythoner/workspace_hank/python/pyqt5/PyQt-gpl-5.1/sip/QtQuick/qsgnode.sip"
#include <qsgnode.h>
#line 42 "/home/pythoner/workspace_hank/python/pyqt5/PyQt-gpl-5.1/QtQuick/sipQtQuickQSGTransformNode.cpp"
...
public:
    sipQSGTransformNode();
    sipQSGTransformNode(const QSGTransformNode&);
...
sipQSGTransformNode::sipQSGTransformNode(const QSGTransformNode& a0): QSGTransformNode(a0), sipPySelf(0)
{
    memset(sipPyMethods, 0, sizeof (sipPyMethods));
}
...
extern "C" {static void assign_QSGTransformNode(void *, SIP_SSIZE_T, const void *);}
static void assign_QSGTransformNode(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast<QSGTransformNode *>(sipDst)[sipDstIdx] = *reinterpret_cast<const QSGTransformNode *>(sipSrc);
}


extern "C" {static void *array_QSGTransformNode(SIP_SSIZE_T);}
static void *array_QSGTransformNode(SIP_SSIZE_T sipNrElem)
{
    return new QSGTransformNode[sipNrElem];
}


extern "C" {static void *copy_QSGTransformNode(const void *, SIP_SSIZE_T);}
static void *copy_QSGTransformNode(const void *sipSrc, SIP_SSIZE_T sipSrcIdx)
{
    return new QSGTransformNode(reinterpret_cast<const QSGTransformNode *>(sipSrc)[sipSrcIdx]);
}
...
static void *init_type_QSGTransformNode(sipSimpleWrapper *sipSelf, PyObject *sipArgs, PyObject *sipKwds, PyObject **sipUnused, PyObject **, PyObject **sipParseErr)
{
    ...
    {
        const QSGTransformNode* a0;

        if (sipParseKwdArgs(sipParseErr, sipArgs, sipKwds, NULL, sipUnused, "J9", sipType_QSGTransformNode, &a0))
        {
            sipCpp = new sipQSGTransformNode(*a0);
...
static sipEncodedTypeDef supers_QSGTransformNode[] = {{41, 255, 1}};
...
pyqt5ClassTypeDef sipTypeDef_QtQuick_QSGTransformNode = {
{
    ...
    assign_QSGTransformNode,
    array_QSGTransformNode,
    copy_QSGTransformNode,
