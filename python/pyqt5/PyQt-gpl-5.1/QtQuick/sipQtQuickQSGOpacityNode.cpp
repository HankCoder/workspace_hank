...
#include <qsgnode.h>
#line 29 "/home/pythoner/workspace_hank/python/pyqt5/PyQt-gpl-5.1/QtQuick/sipQtQuickQSGOpacityNode.cpp"

#line 30 "/home/pythoner/workspace_hank/python/pyqt5/PyQt-gpl-5.1/sip/QtQuick/qsgnode.sip"
#include <qsgnode.h>
#line 33 "/home/pythoner/workspace_hank/python/pyqt5/PyQt-gpl-5.1/QtQuick/sipQtQuickQSGOpacityNode.cpp"
#line 30 "/home/pythoner/workspace_hank/python/pyqt5/PyQt-gpl-5.1/sip/QtQuick/qsgnode.sip"
#include <qsgnode.h>
#line 36 "/home/pythoner/workspace_hank/python/pyqt5/PyQt-gpl-5.1/QtQuick/sipQtQuickQSGOpacityNode.cpp"
#line 30 "/home/pythoner/workspace_hank/python/pyqt5/PyQt-gpl-5.1/sip/QtQuick/qsgnode.sip"
#include <qsgnode.h>
#line 39 "/home/pythoner/workspace_hank/python/pyqt5/PyQt-gpl-5.1/QtQuick/sipQtQuickQSGOpacityNode.cpp"
...
public:
    sipQSGOpacityNode();
    sipQSGOpacityNode(const QSGOpacityNode&);
...
sipQSGOpacityNode::sipQSGOpacityNode(const QSGOpacityNode& a0): QSGOpacityNode(a0), sipPySelf(0)
{
    memset(sipPyMethods, 0, sizeof (sipPyMethods));
}
...
extern "C" {static void assign_QSGOpacityNode(void *, SIP_SSIZE_T, const void *);}
static void assign_QSGOpacityNode(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast<QSGOpacityNode *>(sipDst)[sipDstIdx] = *reinterpret_cast<const QSGOpacityNode *>(sipSrc);
}


extern "C" {static void *array_QSGOpacityNode(SIP_SSIZE_T);}
static void *array_QSGOpacityNode(SIP_SSIZE_T sipNrElem)
{
    return new QSGOpacityNode[sipNrElem];
}


extern "C" {static void *copy_QSGOpacityNode(const void *, SIP_SSIZE_T);}
static void *copy_QSGOpacityNode(const void *sipSrc, SIP_SSIZE_T sipSrcIdx)
{
    return new QSGOpacityNode(reinterpret_cast<const QSGOpacityNode *>(sipSrc)[sipSrcIdx]);
}
...
static void *init_type_QSGOpacityNode(sipSimpleWrapper *sipSelf, PyObject *sipArgs, PyObject *sipKwds, PyObject **sipUnused, PyObject **, PyObject **sipParseErr)
{
    ...
    {
        const QSGOpacityNode* a0;

        if (sipParseKwdArgs(sipParseErr, sipArgs, sipKwds, NULL, sipUnused, "J9", sipType_QSGOpacityNode, &a0))
        {
            sipCpp = new sipQSGOpacityNode(*a0);
...
static sipEncodedTypeDef supers_QSGOpacityNode[] = {{41, 255, 1}};
...
pyqt5ClassTypeDef sipTypeDef_QtQuick_QSGOpacityNode = {
{
    ...
    assign_QSGOpacityNode,
    array_QSGOpacityNode,
    copy_QSGOpacityNode,
