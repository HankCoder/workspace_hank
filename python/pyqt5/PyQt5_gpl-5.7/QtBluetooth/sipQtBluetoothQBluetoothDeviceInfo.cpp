...
#line 29 "/home/pythoner/workspace_hank/python/pyqt5/PyQt5_gpl-5.7/QtBluetooth/sipQtBluetoothQBluetoothDeviceInfo.cpp"

#line 28 "/home/pythoner/workspace_hank/python/pyqt5/PyQt5_gpl-5.7/sip/QtBluetooth/qbluetoothaddress.sip"
#include <qbluetoothaddress.h>
#line 33 "/home/pythoner/workspace_hank/python/pyqt5/PyQt5_gpl-5.7/QtBluetooth/sipQtBluetoothQBluetoothDeviceInfo.cpp"
#line 27 "sip/QtCore/qstring.sip"
#include <qstring.h>
#line 36 "/home/pythoner/workspace_hank/python/pyqt5/PyQt5_gpl-5.7/QtBluetooth/sipQtBluetoothQBluetoothDeviceInfo.cpp"
#line 28 "/home/pythoner/workspace_hank/python/pyqt5/PyQt5_gpl-5.7/sip/QtBluetooth/qbluetoothuuid.sip"
#include <qbluetoothuuid.h>
#line 39 "/home/pythoner/workspace_hank/python/pyqt5/PyQt5_gpl-5.7/QtBluetooth/sipQtBluetoothQBluetoothDeviceInfo.cpp"
#line 28 "/home/pythoner/workspace_hank/python/pyqt5/PyQt5_gpl-5.7/sip/QtBluetooth/qbluetoothdeviceinfo.sip"
#include <qbluetoothdeviceinfo.h>
#line 42 "/home/pythoner/workspace_hank/python/pyqt5/PyQt5_gpl-5.7/QtBluetooth/sipQtBluetoothQBluetoothDeviceInfo.cpp"
#line 38 "sip/QtCore/qpycore_qlist.sip"
#include <qlist.h>
#line 45 "/home/pythoner/workspace_hank/python/pyqt5/PyQt5_gpl-5.7/QtBluetooth/sipQtBluetoothQBluetoothDeviceInfo.cpp"
#line 28 "/home/pythoner/workspace_hank/python/pyqt5/PyQt5_gpl-5.7/sip/QtBluetooth/qbluetoothdeviceinfo.sip"
#include <qbluetoothdeviceinfo.h>
#line 48 "/home/pythoner/workspace_hank/python/pyqt5/PyQt5_gpl-5.7/QtBluetooth/sipQtBluetoothQBluetoothDeviceInfo.cpp"
...
static sipEnumMemberDef enummembers_QBluetoothDeviceInfo[] = {
    {sipName_AllServices, static_cast<int>(QBluetoothDeviceInfo::AllServices), 24},
    {sipName_AudioService, static_cast<int>(QBluetoothDeviceInfo::AudioService), 24},
    {sipName_AudioVideoDevice, static_cast<int>(QBluetoothDeviceInfo::AudioVideoDevice), 13},
    {sipName_BaseRateAndLowEnergyCoreConfiguration, static_cast<int>(QBluetoothDeviceInfo::BaseRateAndLowEnergyCoreConfiguration), 10},
    {sipName_BaseRateCoreConfiguration, static_cast<int>(QBluetoothDeviceInfo::BaseRateCoreConfiguration), 10},
    {sipName_Camcorder, static_cast<int>(QBluetoothDeviceInfo::Camcorder), 14},
    {sipName_CapturingService, static_cast<int>(QBluetoothDeviceInfo::CapturingService), 24},
    {sipName_CarAudio, static_cast<int>(QBluetoothDeviceInfo::CarAudio), 14},
    {sipName_CardReaderPeripheral, static_cast<int>(QBluetoothDeviceInfo::CardReaderPeripheral), 20},
    {sipName_CellularPhone, static_cast<int>(QBluetoothDeviceInfo::CellularPhone), 21},
    {sipName_CommonIsdnAccessPhone, static_cast<int>(QBluetoothDeviceInfo::CommonIsdnAccessPhone), 21},
    {sipName_ComputerDevice, static_cast<int>(QBluetoothDeviceInfo::ComputerDevice), 13},
    {sipName_CordlessPhone, static_cast<int>(QBluetoothDeviceInfo::CordlessPhone), 21},
    {sipName_DataComplete, static_cast<int>(QBluetoothDeviceInfo::DataComplete), 12},
    {sipName_DataIncomplete, static_cast<int>(QBluetoothDeviceInfo::DataIncomplete), 12},
    {sipName_DataUnavailable, static_cast<int>(QBluetoothDeviceInfo::DataUnavailable), 12},
    {sipName_DesktopComputer, static_cast<int>(QBluetoothDeviceInfo::DesktopComputer), 15},
    {sipName_DigitizerTabletPeripheral, static_cast<int>(QBluetoothDeviceInfo::DigitizerTabletPeripheral), 20},
    {sipName_GamepadPeripheral, static_cast<int>(QBluetoothDeviceInfo::GamepadPeripheral), 20},
    {sipName_GamingDevice, static_cast<int>(QBluetoothDeviceInfo::GamingDevice), 14},
    {sipName_HandheldClamShellComputer, static_cast<int>(QBluetoothDeviceInfo::HandheldClamShellComputer), 15},
    {sipName_HandheldComputer, static_cast<int>(QBluetoothDeviceInfo::HandheldComputer), 15},
    {sipName_HandsFreeDevice, static_cast<int>(QBluetoothDeviceInfo::HandsFreeDevice), 14},
    {sipName_Headphones, static_cast<int>(QBluetoothDeviceInfo::Headphones), 14},
    {sipName_HealthBloodPressureMonitor, static_cast<int>(QBluetoothDeviceInfo::HealthBloodPressureMonitor), 16},
    {sipName_HealthDataDisplay, static_cast<int>(QBluetoothDeviceInfo::HealthDataDisplay), 16},
    {sipName_HealthDevice, static_cast<int>(QBluetoothDeviceInfo::HealthDevice), 13},
    {sipName_HealthGlucoseMeter, static_cast<int>(QBluetoothDeviceInfo::HealthGlucoseMeter), 16},
    {sipName_HealthPulseOximeter, static_cast<int>(QBluetoothDeviceInfo::HealthPulseOximeter), 16},
    {sipName_HealthStepCounter, static_cast<int>(QBluetoothDeviceInfo::HealthStepCounter), 16},
    {sipName_HealthThermometer, static_cast<int>(QBluetoothDeviceInfo::HealthThermometer), 16},
    {sipName_HealthWeightScale, static_cast<int>(QBluetoothDeviceInfo::HealthWeightScale), 16},
    {sipName_HiFiAudioDevice, static_cast<int>(QBluetoothDeviceInfo::HiFiAudioDevice), 14},
    {sipName_ImageCamera, static_cast<int>(QBluetoothDeviceInfo::ImageCamera), 17},
    {sipName_ImageDisplay, static_cast<int>(QBluetoothDeviceInfo::ImageDisplay), 17},
    {sipName_ImagePrinter, static_cast<int>(QBluetoothDeviceInfo::ImagePrinter), 17},
    {sipName_ImageScanner, static_cast<int>(QBluetoothDeviceInfo::ImageScanner), 17},
    {sipName_ImagingDevice, static_cast<int>(QBluetoothDeviceInfo::ImagingDevice), 13},
    {sipName_InformationService, static_cast<int>(QBluetoothDeviceInfo::InformationService), 24},
    {sipName_JoystickPeripheral, static_cast<int>(QBluetoothDeviceInfo::JoystickPeripheral), 20},
    {sipName_KeyboardPeripheral, static_cast<int>(QBluetoothDeviceInfo::KeyboardPeripheral), 20},
    {sipName_KeyboardWithPointingDevicePeripheral, static_cast<int>(QBluetoothDeviceInfo::KeyboardWithPointingDevicePeripheral), 20},
    {sipName_LANAccessDevice, static_cast<int>(QBluetoothDeviceInfo::LANAccessDevice), 13},
    {sipName_LaptopComputer, static_cast<int>(QBluetoothDeviceInfo::LaptopComputer), 15},
    {sipName_Loudspeaker, static_cast<int>(QBluetoothDeviceInfo::Loudspeaker), 14},
    {sipName_LowEnergyCoreConfiguration, static_cast<int>(QBluetoothDeviceInfo::LowEnergyCoreConfiguration), 10},
    {sipName_Microphone, static_cast<int>(QBluetoothDeviceInfo::Microphone), 14},
    {sipName_MiscellaneousDevice, static_cast<int>(QBluetoothDeviceInfo::MiscellaneousDevice), 13},
    {sipName_NetworkFullService, static_cast<int>(QBluetoothDeviceInfo::NetworkFullService), 19},
    {sipName_NetworkLoadFactorFive, static_cast<int>(QBluetoothDeviceInfo::NetworkLoadFactorFive), 19},
    {sipName_NetworkLoadFactorFour, static_cast<int>(QBluetoothDeviceInfo::NetworkLoadFactorFour), 19},
    {sipName_NetworkLoadFactorOne, static_cast<int>(QBluetoothDeviceInfo::NetworkLoadFactorOne), 19},
    {sipName_NetworkLoadFactorSix, static_cast<int>(QBluetoothDeviceInfo::NetworkLoadFactorSix), 19},
    {sipName_NetworkLoadFactorThree, static_cast<int>(QBluetoothDeviceInfo::NetworkLoadFactorThree), 19},
    {sipName_NetworkLoadFactorTwo, static_cast<int>(QBluetoothDeviceInfo::NetworkLoadFactorTwo), 19},
    {sipName_NetworkNoService, static_cast<int>(QBluetoothDeviceInfo::NetworkNoService), 19},
    {sipName_NetworkingService, static_cast<int>(QBluetoothDeviceInfo::NetworkingService), 24},
    {sipName_NoService, static_cast<int>(QBluetoothDeviceInfo::NoService), 24},
    {sipName_ObjectTransferService, static_cast<int>(QBluetoothDeviceInfo::ObjectTransferService), 24},
    {sipName_PeripheralDevice, static_cast<int>(QBluetoothDeviceInfo::PeripheralDevice), 13},
    {sipName_PhoneDevice, static_cast<int>(QBluetoothDeviceInfo::PhoneDevice), 13},
    {sipName_PointingDevicePeripheral, static_cast<int>(QBluetoothDeviceInfo::PointingDevicePeripheral), 20},
    {sipName_PortableAudioDevice, static_cast<int>(QBluetoothDeviceInfo::PortableAudioDevice), 14},
    {sipName_PositioningService, static_cast<int>(QBluetoothDeviceInfo::PositioningService), 24},
    {sipName_RemoteControlPeripheral, static_cast<int>(QBluetoothDeviceInfo::RemoteControlPeripheral), 20},
    {sipName_RenderingService, static_cast<int>(QBluetoothDeviceInfo::RenderingService), 24},
    {sipName_SensingDevicePeripheral, static_cast<int>(QBluetoothDeviceInfo::SensingDevicePeripheral), 20},
    {sipName_ServerComputer, static_cast<int>(QBluetoothDeviceInfo::ServerComputer), 15},
    {sipName_SetTopBox, static_cast<int>(QBluetoothDeviceInfo::SetTopBox), 14},
    {sipName_SmartPhone, static_cast<int>(QBluetoothDeviceInfo::SmartPhone), 21},
    {sipName_TelephonyService, static_cast<int>(QBluetoothDeviceInfo::TelephonyService), 24},
    {sipName_ToyController, static_cast<int>(QBluetoothDeviceInfo::ToyController), 22},
    {sipName_ToyDevice, static_cast<int>(QBluetoothDeviceInfo::ToyDevice), 13},
    {sipName_ToyDoll, static_cast<int>(QBluetoothDeviceInfo::ToyDoll), 22},
    {sipName_ToyGame, static_cast<int>(QBluetoothDeviceInfo::ToyGame), 22},
    {sipName_ToyRobot, static_cast<int>(QBluetoothDeviceInfo::ToyRobot), 22},
    {sipName_ToyVehicle, static_cast<int>(QBluetoothDeviceInfo::ToyVehicle), 22},
    {sipName_UncategorizedAudioVideoDevice, static_cast<int>(QBluetoothDeviceInfo::UncategorizedAudioVideoDevice), 14},
    {sipName_UncategorizedComputer, static_cast<int>(QBluetoothDeviceInfo::UncategorizedComputer), 15},
    {sipName_UncategorizedDevice, static_cast<int>(QBluetoothDeviceInfo::UncategorizedDevice), 13},
    {sipName_UncategorizedHealthDevice, static_cast<int>(QBluetoothDeviceInfo::UncategorizedHealthDevice), 16},
    {sipName_UncategorizedImagingDevice, static_cast<int>(QBluetoothDeviceInfo::UncategorizedImagingDevice), 17},
    {sipName_UncategorizedMiscellaneous, static_cast<int>(QBluetoothDeviceInfo::UncategorizedMiscellaneous), 18},
    {sipName_UncategorizedPeripheral, static_cast<int>(QBluetoothDeviceInfo::UncategorizedPeripheral), 20},
    {sipName_UncategorizedPhone, static_cast<int>(QBluetoothDeviceInfo::UncategorizedPhone), 21},
    {sipName_UncategorizedToy, static_cast<int>(QBluetoothDeviceInfo::UncategorizedToy), 22},
    {sipName_UncategorizedWearableDevice, static_cast<int>(QBluetoothDeviceInfo::UncategorizedWearableDevice), 23},
    {sipName_UnknownCoreConfiguration, static_cast<int>(QBluetoothDeviceInfo::UnknownCoreConfiguration), 10},
    {sipName_Vcr, static_cast<int>(QBluetoothDeviceInfo::Vcr), 14},
    {sipName_VideoCamera, static_cast<int>(QBluetoothDeviceInfo::VideoCamera), 14},
    {sipName_VideoConferencing, static_cast<int>(QBluetoothDeviceInfo::VideoConferencing), 14},
    {sipName_VideoDisplayAndLoudspeaker, static_cast<int>(QBluetoothDeviceInfo::VideoDisplayAndLoudspeaker), 14},
    {sipName_VideoMonitor, static_cast<int>(QBluetoothDeviceInfo::VideoMonitor), 14},
    {sipName_WearableComputer, static_cast<int>(QBluetoothDeviceInfo::WearableComputer), 15},
    {sipName_WearableDevice, static_cast<int>(QBluetoothDeviceInfo::WearableDevice), 13},
    {sipName_WearableGlasses, static_cast<int>(QBluetoothDeviceInfo::WearableGlasses), 23},
    {sipName_WearableHeadsetDevice, static_cast<int>(QBluetoothDeviceInfo::WearableHeadsetDevice), 14},
    {sipName_WearableHelmet, static_cast<int>(QBluetoothDeviceInfo::WearableHelmet), 23},
    {sipName_WearableJacket, static_cast<int>(QBluetoothDeviceInfo::WearableJacket), 23},
    {sipName_WearablePager, static_cast<int>(QBluetoothDeviceInfo::WearablePager), 23},
    {sipName_WearableWristWatch, static_cast<int>(QBluetoothDeviceInfo::WearableWristWatch), 23},
    {sipName_WiredModemOrVoiceGatewayPhone, static_cast<int>(QBluetoothDeviceInfo::WiredModemOrVoiceGatewayPhone), 21},
};
