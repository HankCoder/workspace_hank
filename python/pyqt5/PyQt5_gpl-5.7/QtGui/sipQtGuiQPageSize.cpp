...
#include <qpagesize.h>
#line 29 "/home/pythoner/workspace_hank/python/pyqt5/PyQt5_gpl-5.7/QtGui/sipQtGuiQPageSize.cpp"

#line 26 "sip/QtCore/qsize.sip"
#include <qsize.h>
#line 33 "/home/pythoner/workspace_hank/python/pyqt5/PyQt5_gpl-5.7/QtGui/sipQtGuiQPageSize.cpp"
#line 27 "sip/QtCore/qstring.sip"
#include <qstring.h>
#line 36 "/home/pythoner/workspace_hank/python/pyqt5/PyQt5_gpl-5.7/QtGui/sipQtGuiQPageSize.cpp"
#line 97 "sip/QtCore/qsize.sip"
#include <qsize.h>
#line 39 "/home/pythoner/workspace_hank/python/pyqt5/PyQt5_gpl-5.7/QtGui/sipQtGuiQPageSize.cpp"
#line 26 "sip/QtCore/qrect.sip"
#include <qrect.h>
#line 42 "/home/pythoner/workspace_hank/python/pyqt5/PyQt5_gpl-5.7/QtGui/sipQtGuiQPageSize.cpp"
#line 164 "sip/QtCore/qrect.sip"
#include <qrect.h>
#line 45 "/home/pythoner/workspace_hank/python/pyqt5/PyQt5_gpl-5.7/QtGui/sipQtGuiQPageSize.cpp"
...
static sipEnumMemberDef enummembers_QPageSize[] = {
    {sipName_A0, static_cast<int>(QPageSize::A0), 182},
    {sipName_A1, static_cast<int>(QPageSize::A1), 182},
    {sipName_A10, static_cast<int>(QPageSize::A10), 182},
    {sipName_A2, static_cast<int>(QPageSize::A2), 182},
    {sipName_A3, static_cast<int>(QPageSize::A3), 182},
    {sipName_A3Extra, static_cast<int>(QPageSize::A3Extra), 182},
    {sipName_A4, static_cast<int>(QPageSize::A4), 182},
    {sipName_A4Extra, static_cast<int>(QPageSize::A4Extra), 182},
    {sipName_A4Plus, static_cast<int>(QPageSize::A4Plus), 182},
    {sipName_A4Small, static_cast<int>(QPageSize::A4Small), 182},
    {sipName_A5, static_cast<int>(QPageSize::A5), 182},
    {sipName_A5Extra, static_cast<int>(QPageSize::A5Extra), 182},
    {sipName_A6, static_cast<int>(QPageSize::A6), 182},
    {sipName_A7, static_cast<int>(QPageSize::A7), 182},
    {sipName_A8, static_cast<int>(QPageSize::A8), 182},
    {sipName_A9, static_cast<int>(QPageSize::A9), 182},
    {sipName_AnsiA, static_cast<int>(QPageSize::AnsiA), 182},
    {sipName_AnsiB, static_cast<int>(QPageSize::AnsiB), 182},
    {sipName_AnsiC, static_cast<int>(QPageSize::AnsiC), 182},
    {sipName_AnsiD, static_cast<int>(QPageSize::AnsiD), 182},
    {sipName_AnsiE, static_cast<int>(QPageSize::AnsiE), 182},
    {sipName_ArchA, static_cast<int>(QPageSize::ArchA), 182},
    {sipName_ArchB, static_cast<int>(QPageSize::ArchB), 182},
    {sipName_ArchC, static_cast<int>(QPageSize::ArchC), 182},
    {sipName_ArchD, static_cast<int>(QPageSize::ArchD), 182},
    {sipName_ArchE, static_cast<int>(QPageSize::ArchE), 182},
    {sipName_B0, static_cast<int>(QPageSize::B0), 182},
    {sipName_B1, static_cast<int>(QPageSize::B1), 182},
    {sipName_B10, static_cast<int>(QPageSize::B10), 182},
    {sipName_B2, static_cast<int>(QPageSize::B2), 182},
    {sipName_B3, static_cast<int>(QPageSize::B3), 182},
    {sipName_B4, static_cast<int>(QPageSize::B4), 182},
    {sipName_B5, static_cast<int>(QPageSize::B5), 182},
    {sipName_B5Extra, static_cast<int>(QPageSize::B5Extra), 182},
    {sipName_B6, static_cast<int>(QPageSize::B6), 182},
    {sipName_B7, static_cast<int>(QPageSize::B7), 182},
    {sipName_B8, static_cast<int>(QPageSize::B8), 182},
    {sipName_B9, static_cast<int>(QPageSize::B9), 182},
    {sipName_C5E, static_cast<int>(QPageSize::C5E), 182},
    {sipName_Cicero, static_cast<int>(QPageSize::Cicero), 184},
    {sipName_Comm10E, static_cast<int>(QPageSize::Comm10E), 182},
    {sipName_Custom, static_cast<int>(QPageSize::Custom), 182},
    {sipName_DLE, static_cast<int>(QPageSize::DLE), 182},
    {sipName_Didot, static_cast<int>(QPageSize::Didot), 184},
    {sipName_DoublePostcard, static_cast<int>(QPageSize::DoublePostcard), 182},
    {sipName_Envelope10, static_cast<int>(QPageSize::Envelope10), 182},
    {sipName_Envelope11, static_cast<int>(QPageSize::Envelope11), 182},
    {sipName_Envelope12, static_cast<int>(QPageSize::Envelope12), 182},
    {sipName_Envelope14, static_cast<int>(QPageSize::Envelope14), 182},
    {sipName_Envelope9, static_cast<int>(QPageSize::Envelope9), 182},
    {sipName_EnvelopeB4, static_cast<int>(QPageSize::EnvelopeB4), 182},
    {sipName_EnvelopeB5, static_cast<int>(QPageSize::EnvelopeB5), 182},
    {sipName_EnvelopeB6, static_cast<int>(QPageSize::EnvelopeB6), 182},
    {sipName_EnvelopeC0, static_cast<int>(QPageSize::EnvelopeC0), 182},
    {sipName_EnvelopeC1, static_cast<int>(QPageSize::EnvelopeC1), 182},
    {sipName_EnvelopeC2, static_cast<int>(QPageSize::EnvelopeC2), 182},
    {sipName_EnvelopeC3, static_cast<int>(QPageSize::EnvelopeC3), 182},
    {sipName_EnvelopeC4, static_cast<int>(QPageSize::EnvelopeC4), 182},
    {sipName_EnvelopeC5, static_cast<int>(QPageSize::EnvelopeC5), 182},
    {sipName_EnvelopeC6, static_cast<int>(QPageSize::EnvelopeC6), 182},
    {sipName_EnvelopeC65, static_cast<int>(QPageSize::EnvelopeC65), 182},
    {sipName_EnvelopeC7, static_cast<int>(QPageSize::EnvelopeC7), 182},
    {sipName_EnvelopeChou3, static_cast<int>(QPageSize::EnvelopeChou3), 182},
    {sipName_EnvelopeChou4, static_cast<int>(QPageSize::EnvelopeChou4), 182},
    {sipName_EnvelopeDL, static_cast<int>(QPageSize::EnvelopeDL), 182},
    {sipName_EnvelopeInvite, static_cast<int>(QPageSize::EnvelopeInvite), 182},
    {sipName_EnvelopeItalian, static_cast<int>(QPageSize::EnvelopeItalian), 182},
    {sipName_EnvelopeKaku2, static_cast<int>(QPageSize::EnvelopeKaku2), 182},
    {sipName_EnvelopeKaku3, static_cast<int>(QPageSize::EnvelopeKaku3), 182},
    {sipName_EnvelopeMonarch, static_cast<int>(QPageSize::EnvelopeMonarch), 182},
    {sipName_EnvelopePersonal, static_cast<int>(QPageSize::EnvelopePersonal), 182},
    {sipName_EnvelopePrc1, static_cast<int>(QPageSize::EnvelopePrc1), 182},
    {sipName_EnvelopePrc10, static_cast<int>(QPageSize::EnvelopePrc10), 182},
    {sipName_EnvelopePrc2, static_cast<int>(QPageSize::EnvelopePrc2), 182},
    {sipName_EnvelopePrc3, static_cast<int>(QPageSize::EnvelopePrc3), 182},
    {sipName_EnvelopePrc4, static_cast<int>(QPageSize::EnvelopePrc4), 182},
    {sipName_EnvelopePrc5, static_cast<int>(QPageSize::EnvelopePrc5), 182},
    {sipName_EnvelopePrc6, static_cast<int>(QPageSize::EnvelopePrc6), 182},
    {sipName_EnvelopePrc7, static_cast<int>(QPageSize::EnvelopePrc7), 182},
    {sipName_EnvelopePrc8, static_cast<int>(QPageSize::EnvelopePrc8), 182},
    {sipName_EnvelopePrc9, static_cast<int>(QPageSize::EnvelopePrc9), 182},
    {sipName_EnvelopeYou4, static_cast<int>(QPageSize::EnvelopeYou4), 182},
    {sipName_ExactMatch, static_cast<int>(QPageSize::ExactMatch), 183},
    {sipName_Executive, static_cast<int>(QPageSize::Executive), 182},
    {sipName_ExecutiveStandard, static_cast<int>(QPageSize::ExecutiveStandard), 182},
    {sipName_FanFoldGerman, static_cast<int>(QPageSize::FanFoldGerman), 182},
    {sipName_FanFoldGermanLegal, static_cast<int>(QPageSize::FanFoldGermanLegal), 182},
    {sipName_FanFoldUS, static_cast<int>(QPageSize::FanFoldUS), 182},
    {sipName_Folio, static_cast<int>(QPageSize::Folio), 182},
    {sipName_FuzzyMatch, static_cast<int>(QPageSize::FuzzyMatch), 183},
    {sipName_FuzzyOrientationMatch, static_cast<int>(QPageSize::FuzzyOrientationMatch), 183},
    {sipName_Imperial10x11, static_cast<int>(QPageSize::Imperial10x11), 182},
    {sipName_Imperial10x13, static_cast<int>(QPageSize::Imperial10x13), 182},
    {sipName_Imperial10x14, static_cast<int>(QPageSize::Imperial10x14), 182},
    {sipName_Imperial12x11, static_cast<int>(QPageSize::Imperial12x11), 182},
    {sipName_Imperial15x11, static_cast<int>(QPageSize::Imperial15x11), 182},
    {sipName_Imperial7x9, static_cast<int>(QPageSize::Imperial7x9), 182},
    {sipName_Imperial8x10, static_cast<int>(QPageSize::Imperial8x10), 182},
    {sipName_Imperial9x11, static_cast<int>(QPageSize::Imperial9x11), 182},
    {sipName_Imperial9x12, static_cast<int>(QPageSize::Imperial9x12), 182},
    {sipName_Inch, static_cast<int>(QPageSize::Inch), 184},
    {sipName_JisB0, static_cast<int>(QPageSize::JisB0), 182},
    {sipName_JisB1, static_cast<int>(QPageSize::JisB1), 182},
    {sipName_JisB10, static_cast<int>(QPageSize::JisB10), 182},
    {sipName_JisB2, static_cast<int>(QPageSize::JisB2), 182},
    {sipName_JisB3, static_cast<int>(QPageSize::JisB3), 182},
    {sipName_JisB4, static_cast<int>(QPageSize::JisB4), 182},
    {sipName_JisB5, static_cast<int>(QPageSize::JisB5), 182},
    {sipName_JisB6, static_cast<int>(QPageSize::JisB6), 182},
    {sipName_JisB7, static_cast<int>(QPageSize::JisB7), 182},
    {sipName_JisB8, static_cast<int>(QPageSize::JisB8), 182},
    {sipName_JisB9, static_cast<int>(QPageSize::JisB9), 182},
    {sipName_LastPageSize, static_cast<int>(QPageSize::LastPageSize), 182},
    {sipName_Ledger, static_cast<int>(QPageSize::Ledger), 182},
    {sipName_Legal, static_cast<int>(QPageSize::Legal), 182},
    {sipName_LegalExtra, static_cast<int>(QPageSize::LegalExtra), 182},
    {sipName_Letter, static_cast<int>(QPageSize::Letter), 182},
    {sipName_LetterExtra, static_cast<int>(QPageSize::LetterExtra), 182},
    {sipName_LetterPlus, static_cast<int>(QPageSize::LetterPlus), 182},
    {sipName_LetterSmall, static_cast<int>(QPageSize::LetterSmall), 182},
    {sipName_Millimeter, static_cast<int>(QPageSize::Millimeter), 184},
    {sipName_NPageSize, static_cast<int>(QPageSize::NPageSize), 182},
    {sipName_NPaperSize, static_cast<int>(QPageSize::NPaperSize), 182},
    {sipName_Note, static_cast<int>(QPageSize::Note), 182},
    {sipName_Pica, static_cast<int>(QPageSize::Pica), 184},
    {sipName_Point, static_cast<int>(QPageSize::Point), 184},
    {sipName_Postcard, static_cast<int>(QPageSize::Postcard), 182},
    {sipName_Prc16K, static_cast<int>(QPageSize::Prc16K), 182},
    {sipName_Prc32K, static_cast<int>(QPageSize::Prc32K), 182},
    {sipName_Prc32KBig, static_cast<int>(QPageSize::Prc32KBig), 182},
    {sipName_Quarto, static_cast<int>(QPageSize::Quarto), 182},
    {sipName_Statement, static_cast<int>(QPageSize::Statement), 182},
    {sipName_SuperA, static_cast<int>(QPageSize::SuperA), 182},
    {sipName_SuperB, static_cast<int>(QPageSize::SuperB), 182},
    {sipName_Tabloid, static_cast<int>(QPageSize::Tabloid), 182},
    {sipName_TabloidExtra, static_cast<int>(QPageSize::TabloidExtra), 182},
};
