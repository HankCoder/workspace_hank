...
#line 29 "/home/pythoner/workspace_hank/python/pyqt5/PyQt5_gpl-5.7/QtGui/sipQtGuiQPixelFormat.cpp"
...
static sipEnumMemberDef enummembers_QPixelFormat[] = {
    {sipName_Alpha, static_cast<int>(QPixelFormat::Alpha), 225},
    {sipName_AtBeginning, static_cast<int>(QPixelFormat::AtBeginning), 221},
    {sipName_AtEnd, static_cast<int>(QPixelFormat::AtEnd), 221},
    {sipName_BGR, static_cast<int>(QPixelFormat::BGR), 225},
    {sipName_BigEndian, static_cast<int>(QPixelFormat::BigEndian), 224},
    {sipName_CMYK, static_cast<int>(QPixelFormat::CMYK), 225},
    {sipName_CurrentSystemEndian, static_cast<int>(QPixelFormat::CurrentSystemEndian), 224},
    {sipName_FloatingPoint, static_cast<int>(QPixelFormat::FloatingPoint), 226},
    {sipName_Grayscale, static_cast<int>(QPixelFormat::Grayscale), 225},
    {sipName_HSL, static_cast<int>(QPixelFormat::HSL), 225},
    {sipName_HSV, static_cast<int>(QPixelFormat::HSV), 225},
    {sipName_IMC1, static_cast<int>(QPixelFormat::IMC1), 227},
    {sipName_IMC2, static_cast<int>(QPixelFormat::IMC2), 227},
    {sipName_IMC3, static_cast<int>(QPixelFormat::IMC3), 227},
    {sipName_IMC4, static_cast<int>(QPixelFormat::IMC4), 227},
    {sipName_IgnoresAlpha, static_cast<int>(QPixelFormat::IgnoresAlpha), 223},
    {sipName_Indexed, static_cast<int>(QPixelFormat::Indexed), 225},
    {sipName_LittleEndian, static_cast<int>(QPixelFormat::LittleEndian), 224},
    {sipName_NV12, static_cast<int>(QPixelFormat::NV12), 227},
    {sipName_NV21, static_cast<int>(QPixelFormat::NV21), 227},
    {sipName_NotPremultiplied, static_cast<int>(QPixelFormat::NotPremultiplied), 222},
    {sipName_Premultiplied, static_cast<int>(QPixelFormat::Premultiplied), 222},
    {sipName_RGB, static_cast<int>(QPixelFormat::RGB), 225},
    {sipName_UYVY, static_cast<int>(QPixelFormat::UYVY), 227},
    {sipName_UnsignedByte, static_cast<int>(QPixelFormat::UnsignedByte), 226},
    {sipName_UnsignedInteger, static_cast<int>(QPixelFormat::UnsignedInteger), 226},
    {sipName_UnsignedShort, static_cast<int>(QPixelFormat::UnsignedShort), 226},
    {sipName_UsesAlpha, static_cast<int>(QPixelFormat::UsesAlpha), 223},
    {sipName_Y16, static_cast<int>(QPixelFormat::Y16), 227},
    {sipName_Y8, static_cast<int>(QPixelFormat::Y8), 227},
    {sipName_YUV, static_cast<int>(QPixelFormat::YUV), 225},
    {sipName_YUV411, static_cast<int>(QPixelFormat::YUV411), 227},
    {sipName_YUV420P, static_cast<int>(QPixelFormat::YUV420P), 227},
    {sipName_YUV420SP, static_cast<int>(QPixelFormat::YUV420SP), 227},
    {sipName_YUV422, static_cast<int>(QPixelFormat::YUV422), 227},
    {sipName_YUV444, static_cast<int>(QPixelFormat::YUV444), 227},
    {sipName_YUYV, static_cast<int>(QPixelFormat::YUYV), 227},
    {sipName_YV12, static_cast<int>(QPixelFormat::YV12), 227},
};
